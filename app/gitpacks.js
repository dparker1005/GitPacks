  ...
  overlay.innerHTML = `
    ...
    <div class="fullscreen-bottom">
      ${!_currentUser ? `<div class="fs-sales-pitch">
        ${localStorage.getItem('gp_ref') ? `<p class="fs-referral-nudge">You were invited! Sign up and you <strong>both</strong> get <strong>5 bonus packs</strong>.</p>` : ''}
        <p class="fs-sales-text">Open packs, collect contributors, and climb the leaderboard.</p>
        <p class="fs-sales-cta"><strong>${localStorage.getItem('gp_ref') ? '15' : '10'} free packs</strong> when you sign up. Contribute to a repo and <strong>get your own card for free</strong>.</p>
