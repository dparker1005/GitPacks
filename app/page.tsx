    ...
    <div id="gallery-screen">
      ...
      {!user && !authLoading && (
        <div className="landing" id="landing-section">
          ...
          <h2 className="landing-heading">Open packs. Collect contributors. Complete the set.</h2>

          <div className="landing-cards" id="landing-cards"></div>

          <div id="featured-repos"></div>
            ...
            <div className="landing-steps">
              ...
              <div className="landing-step">
                ...
                <div className="landing-step-text">
                  ...
                  <p>Daily and weekly competitions on featured repos. Collect cards from the featured repo to build power and win bonus packs.</p>
                </div>
              </div>
              <div className="landing-step">
